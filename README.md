...
A Detection Engineering and Threat Hunting lab focused on identifying malicious PowerShell activity, authentication failures, and suspicious behavior in a Windows Active Directory environment using Sysmon and Wazuh SIEM.

Project Overview

This lab simulates attacker behavior within a Windows Active Directory environment and demonstrates how defensive telemetry can be collected, correlated, and analyzed using:
...
The objective of this project is to strengthen blue team detection capabilities by monitoring attacker techniques commonly used in enterprise environments.

Lab Architecture
Attacker Activity (PowerShell / Authentication Abuse)
                │
                ▼
...
Active Directory DS	Identity and domain services
...
PowerShell persistence simulation
Sysmon Detection
...
Wazuh manager restart after rule deployment
...
Disclaimer
This project was created strictly for educational and defensive cybersecurity purposes in a controlled lab environment.
